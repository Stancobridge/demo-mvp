      ...
      <div className="flex items-center justify-between gap-4 px-4">
        ...
        <div className="flex gap-6 items-center justify-center">
          ...
          <h1
            ...
            className="text-2xl font-grifter cursor-pointer text-cyan-300"
          >
            SMART
          </h1>
        ...
        <div className="ml-auto hidden md:flex items-center justify-end">
          <div className="w-full max-w-md flex items-center bg-transparent border border-white/20 rounded-full px-4 py-1">
            <input
              type="text"
              placeholder="Search"
              className="flex-1 bg-transparent border-none outline-none font-aeonik text-md text-white/70 placeholder-white/60 focus:ring-0 focus:outline-none"
            />
